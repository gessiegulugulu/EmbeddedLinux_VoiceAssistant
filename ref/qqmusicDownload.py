...
def get_mp3_url(songs,num):
    ...
    songmid = songs['list'][num]['songmid']
    print('songmind:',media_mid)
    url_1 = 'https://c.y.qq.com/base/fcgi-bin/fcg_music_express_mobile3.fcg?g_tk=5381&cid=205361747&songmid=%s&filename=C400%s.m4a&guid=6800588318' % (songmid,songmid)
    # url_1='https://c.y.qq.com/base/fcgi-bin/fcg_music_express_mobile3.fcg?format=json205361747&g_tk=5381&platform=yqq&cid=205361747&songmid=003lghpv0jfFXG&filename=C400%s.m4a&guid=126548448'% (songmid,songmid)
